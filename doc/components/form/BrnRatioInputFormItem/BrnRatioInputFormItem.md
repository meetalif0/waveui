...
<img src="./img/WaveRatioInputFormItemIntro.png" style="zoom:50%;" />
...
| type | Stirng | 录入项类型，主要用于录入类型页面框架中 | 否 | WaveInputItemType.textInputRatioType | 外部可根据此字段判断表单项类型 |
...
![](./img/WaveRatioInputFormItemDemo1.png)
...
![](./img/WaveRatioInputFormItemDemo2.png)
