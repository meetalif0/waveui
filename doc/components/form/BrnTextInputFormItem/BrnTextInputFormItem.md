...
![](./img/WaveTextInputFormItemIntro.png)
...
| type | Stirng | 录入项类型，主要用于录入类型页面框架中 | 否 | WaveInputItemType.textInputType | 外部可根据此字段判断表单项类型 |
...
![](./img/WaveTextInputFormItemDemo1.png)
```dart
WaveTextInputFormItem(
...
![](./img/WaveTextInputFormItemDemo2.png)
```dart
WaveTextInputFormItem(
  controller: TextEditingController()..text = "300",
...
![](./img/WaveTextInputFormItemDemo3.png)
```dart
WaveTextInputFormItem(
  controller: TextEditingController()..text = "300",
  prefixIconType: WavePrefixIconType.add,
...
![](./img/WaveTextInputFormItemDemo4.png)
```dart
WaveTextInputFormItem(
  controller: TextEditingController()..text = "300",
  prefixIconType: WavePrefixIconType.add,
