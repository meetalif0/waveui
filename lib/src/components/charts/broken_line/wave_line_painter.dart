...
import 'package:waveui/src/components/charts/broken_line/wave_base_painter.dart';
import 'package:waveui/src/components/charts/broken_line/wave_line_data.dart';
import 'package:waveui/src/components/charts/broken_line/monotone_x.dart';
import 'package:waveui/src/theme/wave_theme_configurator.dart';
import 'package:flutter/material.dart';
import 'package:path_drawing/path_drawing.dart';

class WaveLinePainter extends WaveBasePainter {
  ...
  /// x轴 刻度
  List<WaveDialItem>? xDialValues;

  /// y轴左侧刻度显示，不传则没有
  List<WaveDialItem>? yDialValues;
  ...
  void _initValue() {
    ...
    yDialColor ??= WaveThemeConfigurator.instance
        .getConfig()
        .commonConfig
        .colorTextSecondary;
    hintLineColor ??=
  ...
  void _drawPointDisplayText(Canvas canvas) {
    if (_linePointPositions.isNotEmpty) {
      for (int lineIndex = 0;
          ...
          lineIndex++) {
        WavePointsLine item = lines[lineIndex];
