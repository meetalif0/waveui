import 'package:waveui/src/components/charts/wave_progress_chart/wave_progress_chart_painter.dart';
import 'package:flutter/foundation.dart';
import 'package:flutter/material.dart';

/// 在进度条上展示的 Widget
typedef WaveProgressIndicatorBuilder = Widget Function(
    BuildContext context, double value);

/// 一个简单的进度条 Widget，支持数据变化时的动画
class WaveProgressChart extends StatefulWidget {
  /// 宽度，默认0
  final double width;
  ...
  final WaveProgressIndicatorBuilder? waveProgressIndicatorBuilder;
  ...
  State<StatefulWidget> createState() {
    return WaveProgressChartState();
  }
}

class WaveProgressChartState extends State<WaveProgressChart>
  ...
  @override
  void didUpdateWidget(covariant WaveProgressChart oldWidget) {
    ...
    return Stack(
      children: <Widget>[
        CustomPaint(
          ...
          painter: WaveProgressChartPainter(
            value: _value,
        ...
        Container(
          ...
          child: IndicatorWidgetBuilder(
            ...
            waveProgressIndicatorBuilder: widget.waveProgressIndicatorBuilder,
          ),
        )
      ],
    );
...
class _IndicatorWidgetBuilderState extends State<IndicatorWidgetBuilder> {
  ...
  @override
  Widget build(BuildContext context) {
    final WaveProgressIndicatorBuilder? builder =
        widget.waveProgressIndicatorBuilder;
