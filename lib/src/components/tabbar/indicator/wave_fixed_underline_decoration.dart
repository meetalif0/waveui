...
class WaveFixedUnderlineIndicator extends Decoration {
  /// Create an underline style selected tab indicator.
  ///
  /// The [borderSide] and [insets] arguments must not be null.
  const WaveFixedUnderlineIndicator({
  ...
  Decoration? lerpFrom(Decoration? a, double t) {
    if (a is WaveFixedUnderlineIndicator) {
      return WaveFixedUnderlineIndicator(
  ...
  Decoration? lerpTo(Decoration? b, double t) {
    if (b is WaveFixedUnderlineIndicator) {
      return WaveFixedUnderlineIndicator(
...
class _FixedUnderlinePainter extends BoxPainter {
  ...
  final WaveFixedUnderlineIndicator decoration;
