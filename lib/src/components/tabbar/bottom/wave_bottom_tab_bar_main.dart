...
import 'package:waveui/src/components/tabbar/bottom/wave_bottom_tab_bar_item.dart';
...
/// tabBar显示状态
enum WaveBottomTabBarDisplayType {
  /// 固定显示状态
  fixed,
...
/// 简述：底部导航栏组件容器，其中[WaveBottomTabBarItem]控制每个tab的状态
/// 功能：底部导航栏主容器控制，如点击动画，每个tab的悬浮样式
/// 特别注意：默认关闭点击动画，为固定显示状态
class WaveBottomTabBar extends StatefulWidget {
  WaveBottomTabBar({
    Key? key,
    required this.items,
    this.onTap,
    ...
    this.isInkResponse = false,
        ...
        assert(
          items.every((WaveBottomTabBarItem item) => item.title != null) ==
              true,
  ...
  final List<WaveBottomTabBarItem> items;
  ...
  final WaveBottomTabBarDisplayType type;
...
/// 底部导航栏中状态控制类
class _BottomTabBarState extends State<WaveBottomTabBar>
  ...
  /// 更新整个widget
  @override
  void didUpdateWidget(WaveBottomTabBar oldWidget) {
    ...
    if (widget.currentIndex != oldWidget.currentIndex) {
      switch (widget.type) {
        case WaveBottomTabBarDisplayType.fixed:
          break;
        case WaveBottomTabBarDisplayType.shifting:
...
class _BottomNavigationTile extends StatelessWidget {
  ...
  final WaveBottomTabBarDisplayType type;
  final WaveBottomTabBarItem item;
