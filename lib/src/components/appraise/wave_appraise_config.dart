...
class WaveAppraiseConfig {
  ...
  /// 取消的回调
  final WaveAppraiseCloseClickCallBack? onCancel;
  ...
  /// 点击icon的回调
  final WaveAppraiseIconClick? iconClickCallback;

  /// 输入框改变的回调
  final WaveInputTextChangeCallback? inputTextChangeCallback;

  /// 选择标签的回调
  final WaveAppraiseTagClick? tagSelectCallback;
