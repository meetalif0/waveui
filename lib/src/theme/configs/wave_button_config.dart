...
/// 按钮基础配置
class WaveButtonConfig extends WaveBaseConfig {
  /// 遵循外部主题配置
  /// 默认为 [WaveDefaultConfigUtils.defaultButtonConfig]
  WaveButtonConfig({
  ...
  double get bigButtonRadius =>
      _bigButtonRadius ??
      WaveDefaultConfigUtils.defaultButtonConfig.bigButtonRadius;
  ...
  double get bigButtonHeight =>
      _bigButtonHeight ??
      WaveDefaultConfigUtils.defaultButtonConfig.bigButtonHeight;
  ...
  double get bigButtonFontSize =>
      _bigButtonFontSize ??
      WaveDefaultConfigUtils.defaultButtonConfig.bigButtonFontSize;
  ...
  double get smallButtonRadius =>
      _smallButtonRadius ??
      WaveDefaultConfigUtils.defaultButtonConfig.smallButtonRadius;
  ...
  double get smallButtonHeight =>
      _smallButtonHeight ??
      WaveDefaultConfigUtils.defaultButtonConfig.smallButtonHeight;
  ...
  double get smallButtonFontSize =>
      ...
      WaveDefaultConfigUtils.defaultButtonConfig.smallButtonFontSize;
  ...
  void initThemeConfig(
    ...
    WaveButtonConfig userConfig = WaveThemeConfigurator.instance
  ...
  WaveButtonConfig merge(WaveButtonConfig? other) {
