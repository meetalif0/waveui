...
class WaveTextStyle {
  ...
  WaveTextStyle.withStyle(TextStyle? style) {
    if (style == null) {
      return;
    }
  ...
  void flatTextStyle(WaveTextStyle? defaultTextStyle) {
  ...
  WaveTextStyle merge(WaveTextStyle? other) {
