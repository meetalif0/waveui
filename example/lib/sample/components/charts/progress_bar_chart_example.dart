            ...
            WaveProgressBarChart(
              ...
              barBundleList: [
                WaveProgressBarBundle(barList: [
                  ...
                  WaveProgressBarItem(text: '示例', value: 30, hintValue: 15),
                  WaveProgressBarItem(text: '示例', value: 20, hintValue: 15),
                  WaveProgressBarItem(text: '示例', value: 0, hintValue: 15),
                ], colors: [
                  Color(0xff1545FD),
                  Color(0xff0984F9)
                ]),
              ],
              barChartSelectCallback: (WaveProgressBarItem? barItem) {
                WaveToast.show(barItem?.text ?? '', context);
              },
            ),
            WaveProgressBarChart(
