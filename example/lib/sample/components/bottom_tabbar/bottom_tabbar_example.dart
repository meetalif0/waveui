...
class BottomTabbarExampleState extends State<BottomTabbarExample>
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
          ...
          bottomNavigationBar: WaveBottomTabBar(
            // 选中item后的颜色
          ...
          body: ListView(
            children: <Widget>[
              ...
              WaveBottomTabBar(
                ...
                type: WaveBottomTabBarDisplayType.shifting,
  ...
  List<WaveBottomTabBarItem> _getTabBarItems({int count = 1}) {
    return List<WaveBottomTabBarItem>.generate(
        count,
        (index) => WaveBottomTabBarItem(
              icon: Icon(
                icons[0],
                color: Colors.grey,
              ),
